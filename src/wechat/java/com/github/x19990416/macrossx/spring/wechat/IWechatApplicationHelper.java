...
public interface IWechatApplicationHelper {
	...
	public Optional<WechatApplicationEntryDataUserInfo> getUserInfo(String contentData,String iv,WechatApplicationSessionKey sessionKey ); 
}

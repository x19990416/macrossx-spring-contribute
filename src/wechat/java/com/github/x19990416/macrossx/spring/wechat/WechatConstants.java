...
public interface WechatConstants {
	...
	public static final String CARD_DELETE = "https://api.weixin.qq.com/card/delete?access_token={0}";
	...
	public static final String CARD_CODE_DECRYPT = "https://api.weixin.qq.com/card/code/decrypt?access_token={0}";
	/**
	 * 查看卡券详情
	 */
	public static final String CARD_GET = "https://api.weixin.qq.com/card/get?access_token={0}";
	/**
	 * 获取用户已领取卡券接口
	 */
	public static final String CARD_USER_CARDLIST = "https://api.weixin.qq.com/card/user/getcardlist?access_token={0}";
	/**
	 * 查询Code接口
	 */
	public static final String CARD_CODE_GET = "https://api.weixin.qq.com/card/code/get?access_token={0}";
	/**
	 * 设置卡券失效接口
	 */
	public static final String CARD_CODE_UNAVAILABLE = "https://api.weixin.qq.com/card/code/unavailable?access_token={0}";
